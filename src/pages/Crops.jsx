...
function Crops() {
  ...
  const handleAddCrop = () => {
    if (
      ...
      alert('Please fill in the crop, quantity and price.');
      return;
    }
    ...
    setNewCrop({ name: '', quantity: '', price: '', status: 'Active' });
    setShowForm(false);
  };
  ...
  const handleDeleteCrop = (indexToDelete) => {
    ...
    setCrops(crops.filter((_, index) => index !== indexToDelete));
  };
        ...
        <div className="main-content">
          <div className="listings-page">
            <div className="topbar">
              <div>
                <h2>My Listings</h2>
                <p>Manage and keep track of all your crops in one place.</p>
              </div>
            ...
            {showForm && (
              <div className="crop-form">
                <h3>
                  {editingIndex !== null ? 'Edit Listing' : 'Add New Listing'}
                </h3>
                ...
                <div className="form-buttons">
                  <button className="add-btn" onClick={handleAddCrop}>
                    {editingIndex !== null ? 'Update Listing' : 'Save Listing'}
                  </button>
                  <button
                    ...
                    {crops.length === 0 ? (
                      <tr>
                        <td colSpan="5" className="empty-state">
                          ...
                          <br />
                          Start adding your crops to make them available to
                          buyers.
                        </td>
                      </tr>
                    ) : (
