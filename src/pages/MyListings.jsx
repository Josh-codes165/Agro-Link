    ...
    <DashboardLayout>
      ...
      <section className="listings">
        <div className="listings-container">
          {filteredListings.length === 0 && <p>No {activeTab} listings yet.</p>}
            ...
            <div className="listing-card" key={listing.id}>
              <div className="listing-left">
                ...
                <div className="listing-card-content">
                  <h4>{listing.cropType}</h4>
                  <p className="price">Price: ${listing.pricePerKg} / kg</p>
                  <p className="location">{listing.location} Status</p>
                </div>
              </div>
