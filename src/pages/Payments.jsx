...
function Payments() {
  ...
  const completedPayments = payments
    ...
    .reduce((total, payment) => total + getAmount(payment.amount), 0);
          ...
          <div className="payments-page">
            ...
            <div className="cards payments-summary">
              ...
              <div className="card">
                ...
                <h2>{formatCurrency(pendingPayments)}</h2>
                <p>Awaiting payment</p>
              </div>
              <div className="card">
                <h3>Completed Payments</h3>
                <h2>{formatCurrency(completedPayments)}</h2>
                <p>Received</p>
              </div>
              <div className="card">
                    ...
                    {payments.length === 0 ? (
                      ...
                      payments.map((payment, index) => (
                        <tr key={index}>
                          ...
                          <td>{payment.crop}</td>
                          <td>{formatCurrency(getAmount(payment.amount))}</td>
                          <td>{payment.date}</td>
                          <td>
                            {payment.status === 'Paid' && (
